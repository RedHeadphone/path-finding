...
if len(sys.argv)>1:
    ...
    cv2.createTrackbar("threshold", "test" , 0, 100, on_trackbar)
...
def draw_grid():
    for x in range(1,numbox+1):
        p.draw.line(screen,(0,0,0),(0,x*eachlen),(side,x*eachlen),gridlinewidth)
    for y in range(1,numbox+1):
        p.draw.line(screen,(0,0,0),(y*eachlen,0),(y*eachlen,side),gridlinewidth)
...
Bs=[Button(10,610,"start point",(75,194,197),(52,132,152)),Button(120,610,"end point",(75,194,20),(52,132,30)),
    Button(230,610,"block",(200,132,132),(200,75,75)),Button(340,610,"reset",(132,132,132),(99,75,75)),
